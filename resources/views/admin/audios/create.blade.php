...
<div class="max-w-4xl">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-500 mt-1">
                Create a new audio release, pack, or single track
            </p>
        </div>
    ...
    <form action="/admin/audios"
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-2">Recommended: 1:1 or 16:9 square/rectangular image (JPG, PNG, WebP).</p>
        </div>
        ...
        <div>
            ...
            <p class="text-xs text-gray-500 mt-2">Optional if you want to upload direct sound files (Max: 25MB).</p>
        </div>
